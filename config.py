...
def get_arguments():
    ...
    parser.add_argument('--nfc', type=int, default=32)  #nfc: num of ker
    ...
    parser.add_argument('--noise_amp',type=float,help='addative noise cont weight',default=0.1) # noise_amp
    parser.add_argument('--min_size',type=int,help='image minimal size at the coarser scale',default=25)
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=250)

    #optimization hyper parameters:
    parser.add_argument('--niter', type=int, default=1, help='number of epochs to train MCAN')
