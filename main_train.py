...
if __name__ == '__main__':
    ...
    for epoch in range(0,epoch_num):
        ...
        for train_num in train_range:
            ...
            train(opt, Gs, Ds, Zs, real1s, real2s, NoiseAmp, train_range, train_index, train_i, train_loopnum)
            train_index += 1
            train_i += 1

        # if epoch % 10 == 0 or epoch == len(epoch_range):
        #     print('epoch:[%d/%d]' % (epoch, len(epoch_range)))  # lyq add
